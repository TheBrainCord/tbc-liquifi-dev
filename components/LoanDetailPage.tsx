  ...
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="rounded-2xl border-2 border-[#1e3a8a]/10 bg-gradient-to-br from-blue-50 to-white p-8">
            <div className="flex flex-col sm:flex-row items-start gap-6">
              <div className="flex-1">
                <div className="section-tag">Free Expert Guidance</div>
                <h2 className="text-2xl font-black text-[#0f172a] mt-1">
                  Not Sure Which Loan to Pick?
                </h2>
                <p className="text-slate-500 text-sm mt-2 mb-5">
                  Talk to our loan expert — free of charge. They&apos;ll review
                  your profile, compare lenders, and tell you exactly which
                  option saves you the most money.
                </p>
                <div className="flex flex-wrap gap-3 mb-6">
                  {[
                    "Compares 50+ lenders for you",
                    "Explains hidden charges",
                    "Calls within 6 hours",
                  ].map((t) => (
                    <span
                      key={t}
                      className="flex items-center gap-1.5 text-xs font-semibold text-green-700 bg-green-50 border border-green-100 rounded-full px-3 py-1"
                    >
                      <CheckCircle size={11} />
                      {t}
                    </span>
                ...
                <div className="flex gap-2">
                  <div className="flex">
                    ...
                    <input
                      ...
                      className="input-field rounded-l-none w-44"
                      value={expertPhone}
                      onChange={(e) =>
                  ...
                  <button
                    onClick={() => {
                      if (expertPhone.length === 10) setShowExpertModal(true);
                    }}
                    disabled={expertPhone.length !== 10}
                ...
                <p className="text-xs text-slate-400 mt-2">
                  Free · No spam · Expert calls within 6 hours
                </p>
              </div>
              <div className="hidden sm:flex flex-col items-center justify-center w-32 h-32 bg-[#1e3a8a] rounded-2xl text-white text-center shrink-0">
                <span className="text-3xl font-black">6h</span>
                <span className="text-xs text-blue-300 mt-1">call back</span>
              </div>
            </div>
          </div>
        </div>
